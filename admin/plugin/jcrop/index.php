    ...
    <div class="jcorp_pop">
        <div class="jcorp_warp">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="board">
                <tr>
                    <td height="315" align="center" valign="middle"><img src="../../../<?php echo $imgurl; ?>"
                                                                         id="jcrop_img"/></td>
                </tr>
            </table>
        </div>
            ...
            <form id="crop" action="jcrop.php" method="post" onsubmit="return CheckCoords();">
                ...
                <label>
                    <input type="checkbox" name="wm" id="wm"
                           value="true" <?php if ($cfg_markswitch == 'Y') echo 'checked="checked"' ?> />
                    水印
                </label>
            </form>
        </div>
        <div class="jcorp_btn"><span class="txt">您可以用鼠标在图片上进行拖动选取</span> <span class="btn" id="SaveBtn">保存</span> &nbsp;
            <span class="btn" id="CancelBtn">关闭</span></div>
        <!--[if IE 6]>
